...
Elasticsearch.
See README.mdfor more information."""
...
from sentiment import sentimentalstock_VERSION
__version__ = sentimentalstock_VERSION
...
if __name__ == '__main__':
    ...
    parser.add_argument("-i", "--index", metavar="INDEX", default="sentimentalstock",
                        help="Index name for Elasticsearch (default: sentimentalstock)")
    ...
    parser.add_argument("-V", "--version", action="version",
                        version="sentimentalstock v%s" % sentimentalstock_VERSION,
                        help="Prints version and exits")
    args = parser.parse_args()

    # set up logging
    logger = logging.getLogger('sentimentalstock')
    ...
    |_   _|_| |___|___|_,_|_   _|_|_  |_|_|_|  
      |_|                   |_|   |___|                
          :) = +$   :( = -$    v%s
     https://github.com/shirosaidev/sentimentalstock
            \033[0m""" % (color, sentimentalstock_VERSION)
        print(banner + '\n')
